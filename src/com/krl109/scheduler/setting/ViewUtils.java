...
public class ViewUtils {
    ...
    /*public static void initListView(Context context, ListView listView, String[] prefix, int layout) {
        // By using setAdpater method in listview we an add string array in list.
        listView.setAdapter(new ArrayAdapter<String>(context, layout, prefix));
